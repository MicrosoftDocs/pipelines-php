...
<head>
    ...
    <title>Laravel and Azure Pipelines App</title>
...
<body>
    ...
    <footer class="footer">
        ...
        <ul class="pull-right list-inline">
            <li>
                <a href="https://github.com/unicodeveloper/laravel-pipelines-php">GitHub Project</a>
            </li>
            <li>
                <a href="https://github.com/unicodeveloper/laravel-pipelines-php/issues">Issues</a>
            </li>
        </ul>
        </div>
    </footer>
